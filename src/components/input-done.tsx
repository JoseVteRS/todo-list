    ...
    return (
        <>
            <label className="relative inline-flex items-center">
                ...
                />
                <div className={`w-8 h-8 ${isChecked ? 'bg-green-500 border-green-800' : 'border-gray-400'} rounded-lg grid place-content-center border-2  flex-shrink-0 p-1 transition duration-200 ease-in-out mr-2`}>
                    {isChecked && (
